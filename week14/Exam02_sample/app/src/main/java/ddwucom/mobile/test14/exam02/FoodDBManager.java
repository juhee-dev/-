...
//    DB의 모든 food를 반환
    public ArrayList<Food> getAllFood() {
        ArrayList foodList = new ArrayList(); // foodList 를 만들어 DB를 채운 후 foodList 반환
...
//    DB 에 새로운 food 추가
    public boolean addNewFood(Food newFood) { // Food 객체 DTO 를 전달받아 DB에 추가
...
//    _id 를 기준으로 food 의 이름과 nation 변경
    public boolean modifyFood(Food food) {
        ...
        String whereClause = FoodDBHelper.COL_ID + "=?"; // 조건
